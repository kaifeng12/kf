...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . 'images'.date('/Y'),
		'directory' => $baseDir . 'images'.date('/Y'),
		'maxSize' => 0,
...
includeadmin "plugins/imageresize/plugin.php";
includeadmin "plugins/fileeditor/plugin.php";
includeadmin "plugins/zip/plugin.php";
